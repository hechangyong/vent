...
public class HttpRequestHandler  extends SimpleChannelInboundHandler<FullHttpRequest> {
    ...
    static {
        ...
        try{
            String path = location.toURI() + "static/chat.html";
            path = !path.contains("file:") ? path : path.substring(5);
            INDEX = new File(path);
        } catch (Exception e) {
            throw new IllegalStateException("unable to locate chat.html  ", e);
        }
    }
    ...
    public void channelRead0(ChannelHandlerContext ctx,
        ...
        logger.info("HttpRequestHandler: channelRead0");
        ...
        if (wsUri.equalsIgnoreCase(request.getUri())) {
            ...
            ctx.write(response);
            logger.info("HttpRequestHandler: channelRead0: " + response);
    ...
    private void send100Continue(ChannelHandlerContext ctx) {
        ...
        logger.info("HttpRequestHandler: send100Continue: " + response);
